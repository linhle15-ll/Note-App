...
const FolderCard = ({ id, name, lastUpdated }) => {
    ...
    return (
        <div className="flex flex-col bg-white rounded-[10px] h-30 w-80 gap-3 py-3 px-4 border border-lightGrey transition-all duration-300 ease-in-out transform hover:shadow-custom hover:scale-105" 
        >
            {/* tags */}
